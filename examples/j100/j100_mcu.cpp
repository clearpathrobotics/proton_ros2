...
void update_nmea()
{
  ...
  nmea_bundle.getSignal("sentence").setValue<std::string>(gen_random_string(rand() %
    nmea_bundle.getSignal("sentence").getCapacity()));
...
void update_motor_feedback()
{
  ...
  feedback_bundle.getSignal("drivers_current").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
  feedback_bundle.getSignal("drivers_bridge_temperature").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
  feedback_bundle.getSignal("drivers_motor_temperature").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
  feedback_bundle.getSignal("drivers_driver_fault").setValue<proton::list_bool>(
    {static_cast<bool>(rand() % 2), static_cast<bool>(rand() % 2)});
  feedback_bundle.getSignal("drivers_duty_cycle").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
  feedback_bundle.getSignal("drivers_measured_velocity").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
  feedback_bundle.getSignal("drivers_measured_travel").setValue<proton::list_float>(
    {static_cast<float>(rand()), static_cast<float>(rand())});
