...
{
  node->getBundle("emergency_stop").getSignal("data").setValue<bool>(!node->getBundle(
    "emergency_stop").getSignal("data").getValue<bool>());
...
void update_pinout_state()
{
  ...
  pinout_state_bundle.getSignal("inputs").setValue<proton::list_bool>({rand() % 2, rand() % 2,
      rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2});
  pinout_state_bundle.getSignal("outputs").setValue<proton::list_bool>({rand() % 2, rand() % 2,
      rand() % 2, rand() % 2, rand() % 2, rand() % 2, rand() % 2});
  pinout_state_bundle.getSignal("output_periods").setValue<proton::list_uint32>({rand(), rand(),
